   ...
   * 1. "Production Planning" removed as a top-level nav item.
   * 2. "Manufacturing" is now a dropdown with 10 children:
   *      Production Planning, Work Orders, Resources, Schedule,
   *      Bill of Materials (BOM), Production, Quality Control,
   *      Machines, Maintenance, Production Reports.
   * 3. Real logged-in user name/role/avatar from usePermissions().
   * ============================================================
   */
...
{ label: "Customers", path: "/contacts/customers" },
    ...
    // ── Manufacturing (includes Production Planning as first child) ──────────
    {
      ...
      children: [
        ...
        { label: "Bill of Materials (BOM)", path: "/manufacturing/bom" },
        { label: "Production",              path: "/manufacturing/production" },
        { label: "Quality Control",         path: "/manufacturing/quality-control" },
        { label: "Machines",                path: "/manufacturing/machines" },
        { label: "Maintenance",             path: "/manufacturing/maintenance" },
        { label: "Production Reports",      path: "/manufacturing/reports" },
      ],
    },
...
return pathname.startsWith(item.path);
  ...
  export default function Sidebar() {
    ...
    // Filter nav items by plan + permissions
